        ...
        businessElement += `<div class='media-story'>`;
            businessElement += `<div class='biz-attributes'>`;
                businessElement += `<div class='main-attributes'>`;
                    businessElement += `<div class='search-result-title'><span class='indexed-biz-name'><a class='biz-name' id='${businessData.id}' href='/business/${businessData.alias}'><span>${businessData.name}</span></a></span></div>`;
